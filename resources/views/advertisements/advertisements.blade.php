...
<h1 class="text-6xl font-bold" ">كل الإعلانات</h1>
</div>
<div class="container sm:grid  mx-auto  ">
<a href="/advertisements/create"   id="r1" style="padding: 7px;margin-top:0%;background:#00BFFF">إنشاء إعلان</a>
</div>
<div class="container" dir="rtl">
  ...
  <div class="row g-0">
    <div class="col-md-4" style="background: #00BFFF; text-align:center;">
